...
class Issue(models.Model):
    ...
    opened_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='opened_issues')
    closed_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='closed_issues', null=True, default=None,
                                  blank=True)
